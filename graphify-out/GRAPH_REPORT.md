...
## Corpus Check
- 488 files · ~292,390 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3553 nodes · 7931 edges · 252 communities (172 shown, 80 thin omitted)
...
## Communities (252 total, 80 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.07
Nodes (51): createAdminUser(), createManualReservation(), createManualReservationSchema, deleteAdminUser(), deleteManualReservation(), encodeManualReservationReason(), getAdminStats(), getAllBookings() (+43 more)
...
Cohesion: 0.12
Nodes (24): AdminPage(), ManualReservationPayload, parseManualReservationPayload(), CarsPage(), CheckoutPage(), HomePage(), LogoutButton(), ProfilePage() (+16 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (45): firaMono, metadata, notoSans, BookingReview, BookingReviewSection(), BookingReviewSectionProps, Providers(), Toast (+37 more)

### Community 4 - "Community 4"
Cohesion: 0.14
Nodes (24): BusinessConfigurationLayout(), AuthorizationDecision, AuthorizationDenialReason, Capability, CapabilityPrincipal, checkAllCapabilities(), checkAnyCapability(), checkCapability() (+16 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (78): Avatar(), AvatarFallback(), AvatarImage(), BreadcrumbEllipsis(), BreadcrumbItem(), BreadcrumbLink(), BreadcrumbList(), BreadcrumbPage() (+70 more)

### Community 6 - "Community 6"
Cohesion: 0.16
Nodes (20): ConfirmationConfiguration, PaymentConfiguration, confirmationConfigurationSchema, actorName(), audit(), cloneConfirmation(), clonePayment(), ConfirmationRow (+12 more)
...
Cohesion: 0.13
Nodes (35): bookingQuoteSchema, formatDateForLocale(), getBookingQuote(), normalizeBookingLocale(), publicQuote(), updateBookingStatus(), CheckoutClient(), BookingConfirmationConfiguration (+27 more)
...
Cohesion: 0.05
Nodes (23): AccordionContent(), AccordionItem(), AccordionTrigger(), ContextMenuCheckboxItem(), ContextMenuContent(), ContextMenuItem(), ContextMenuLabel(), ContextMenuRadioItem() (+15 more)
...
Cohesion: 0.09
Nodes (18): bookingStepSchema, bookingWorkflowConfigurationSchema, confirmationSectionSchema, customerDriverRequirementsConfigurationSchema, customerFieldModeSchema, customerFieldsSchema, documentPolicyConfigurationSchema, documentRequirementModeSchema (+10 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (27): companySettingsSchema, getCompanySettings(), ContactPage(), DatenschutzPage(), ImpressumPage(), LocaleLayout(), DemoLogin(), WiderrufPage() (+19 more)
...
Cohesion: 0.12
Nodes (18): toggleSavedCar(), BookingsPage(), BookNowButton(), CarAvailabilityCalendar(), CarDetailPage(), BookingSuccessModal(), BookingSuccessModalProps, Car (+10 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (7): ValidatedDocumentFile, DeletionRecord, DocumentRecord, IntentRecord, objectFrom(), PrismaDocumentLifecycleRepository, InMemoryDocumentLifecycleRepository

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (9): DocumentCleanupService, DocumentDeletionService, PrivateDocumentLifecycleService, TERMINAL_INTENTS, PrivateDocumentOperationsMonitoringService, DocumentLifecycleRepository, PrivateObjectListPage, MalwareScanner (+1 more)

### Community 20 - "Community 20"
Cohesion: 0.18
Nodes (16): FleetCoverageSummary(), CONFIGURATION_DOMAIN_IDS, buildReleasePreview(), changedDomains(), coverage(), FleetCoverageSummary, fleetIssues(), impactFor() (+8 more)
...
Cohesion: 0.13
Nodes (16): Car, CarsClient(), categories, CategoryFilter(), CategoryFilterProps, FilterBar(), FilterBarProps, Select() (+8 more)
...
Cohesion: 0.06
Nodes (39): ACTIVE_PDF_MARKERS, detect(), safeExtension(), sha256(), UNSAFE_EXTENSIONS, validateDocumentFile(), evaluateDocumentInfrastructureHealth(), evaluateProductionDocumentHealth() (+31 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (35): POST(), GET(), DocumentReviewQueuePage(), DocumentReviewQueue(), DocumentSecurityPage(), loadSecurityPage(), CAPABILITIES, DocumentAccessService (+27 more)

### Community 29 - "Community 29"
Cohesion: 0.21
Nodes (13): BookingFlowPage(), CustomerInformationPage(), DocumentsConfigurationPage(), DriverRequirementsPage(), InsurancePage(), BusinessConfigurationOverviewPage(), ConfigurationOverview(), Phase6DraftControls() (+5 more)

### Community 30 - "Community 30"
Cohesion: 0.09
Nodes (26): BOOKING_STEPS, CONFIRMATION_SECTIONS, ConfirmationContentTranslation, ConfirmationSection, CUSTOMER_FIELD_MODES, CustomerDocumentType, CustomerFieldMode, DOCUMENT_REQUIREMENT_MODES (+18 more)
...
Cohesion: 0.25
Nodes (12): DriverRequirementsForm(), CalendarDate, compare(), evaluateDriverEligibility(), fullMonths(), fullYears(), parseDate(), zonedDate() (+4 more)
...
Cohesion: 0.11
Nodes (17): AuditEventList(), actorName(), domainByDatabaseValue, mapDomains(), releaseAggregate(), ReleaseRow, versionSummary(), AuditEventRepository (+9 more)

### Community 47 - "Community 47"
Cohesion: 0.13
Nodes (15): autoprefixer, next-auth, dependencies, autoprefixer, next-auth, @radix-ui/react-checkbox, @radix-ui/react-context-menu, @radix-ui/react-dialog (+7 more)

### Community 48 - "Community 48"
Cohesion: 0.14
Nodes (16): ActiveInsuranceOffer, DRIVER_ELIGIBILITY_CODES, DriverEligibilityCode, DriverEligibilityIssue, DriverEligibilityResult, EffectiveBookingField, EffectiveBookingStep, BookingStep (+8 more)

### Community 58 - "Community 58"
Cohesion: 0.08
Nodes (35): ReadinessCode, resolveDocumentReadiness(), LegalHoldRecord, PolicyRecord, RequirementRecord, ReviewDecisionRecord, ReviewQueueItem, SessionRecord (+27 more)

### Community 60 - "Community 60"
Cohesion: 0.08
Nodes (56): archiveLegalVersionAction(), attachLegalDraftToReleaseAction(), createLegalAcceptanceDraftAction(), createLegalDraftAction(), discardLegalDraftAction(), failure(), publishLegalVersionAction(), refresh() (+48 more)
...
Cohesion: 0.16
Nodes (13): ConfigurationDbClient, PrismaBusinessConfigurationRepository, activateDraftRelease(), generateReleasePreview(), loadConfigurationOverview(), routeFor(), statusFromOutcome(), validateDraftRelease() (+5 more)

### Community 67 - "Community 67"
Cohesion: 0.16
Nodes (18): BookingFlowStepList(), labels, unavailable, inputKey, maskLicenceNumber(), metadata, resolveEffectiveBookingFields(), systemRequired (+10 more)

### Community 72 - "Community 72"
Cohesion: 0.10
Nodes (32): POST(), PUT(), POST(), schema, authorized(), JOBS, POST(), POST() (+24 more)
...
Cohesion: 0.13
Nodes (31): ConfiguredRentalQuote, quoteConfiguredVehicleRental(), PublicBookingConfiguration, PricingQuoteView, calculatePricing(), monthDays(), CurrencyCode, fractionToBasisPoints() (+23 more)
...
Cohesion: 0.18
Nodes (28): attachPhase6DraftsAction(), base, createPhase6DraftAction(), createSchema, customerSchema, discardPhase6DraftAction(), failure(), insuranceSchema (+20 more)
...
Cohesion: 0.17
Nodes (12): generatePricingPreviewAction(), BillingConfigurationPage(), PricingConfigurationPage(), BillingRuleForm(), display(), DraftLivePricingComparison(), InsuranceConfigurationForm(), PricingVersionHeader() (+4 more)
...
Cohesion: 0.13
Nodes (21): ActiveLegalDocumentRecord, ActivePhase6Record, mapLegalDocument(), PrismaBookingConfigurationRepository, BookingWorkflowConfiguration, CustomerDriverRequirementsConfiguration, InsuranceConfiguration, actorName() (+13 more)

### Community 123 - "pricing-configuration.ts"
Cohesion: 0.15
Nodes (35): actionError(), attachPricingDraftToReleaseAction(), bulkSchema, createPricingDraftAction(), discardPricingDraftAction(), draftSchema, previewSchema, revalidatePricing() (+27 more)

### Community 124 - "configuration-overview.tsx"
Cohesion: 0.15
Nodes (17): CapabilityGuard(), ConfigurationEmptyState(), ConfigurationHealthSummary(), ConfigurationIssueList(), ConfigurationStatusBadge(), labels, styles, DomainStatusCard() (+9 more)
...
Cohesion: 0.12
Nodes (21): CONFIGURATION_HEALTH_STATUS, ConfigurationDomainHealth, ConfigurationHealthDomainInput, ConfigurationHealthReport, ConfigurationHealthStatus, evaluateConfigurationHealth(), findingFromIssue(), statusForDomain() (+13 more)

### Community 128 - "booking-applications.ts"
Cohesion: 0.12
Nodes (10): documentError(), PrivateObjectReference, mapVercelBlobError(), LocalPrivateDocumentStorage, assertVercelBlobPathname(), createVercelBlobPathname(), environmentBlobPrefix(), VercelBlobPrivateStorageAdapter (+2 more)

### Community 129 - "repositories.ts"
Cohesion: 0.13
Nodes (13): DbClient, PrismaPricingContextRepository, ActiveBusinessConfigurationRepository, ActiveReleasePricingRecord, BookingPricingSnapshotRepository, FleetRateSetRepository, LegacyVehicleRateRecord, VehicleRateRepository (+5 more)
...
Cohesion: 0.18
Nodes (11): normalizeAndValidateBookingFields(), SubmittedLegalAcknowledgements, LegacyPricingAdapterInput, quoteLegacyPricing(), assertRequiredLegalAcknowledgements(), AuthoritativeBookingInput, createAuthoritativeBooking(), bookingTotalFromSnapshot() (+3 more)
...
Cohesion: 0.22
Nodes (10): CarAvailabilityCalendarProps, UnavailableDateRange, DateFilter(), DateFilterProps, Calendar(), CalendarDayButton(), Label(), Popover() (+2 more)

### Community 135 - "page.tsx"
Cohesion: 0.31
Nodes (12): PublishedLegalDocumentPage(), LegalContent(), escapeHtml(), legalContentHash(), legalContentIsUnsafe(), legalManifestHash(), normalizeCanonicalLegalText(), normalizeLegalLocale() (+4 more)
...
Cohesion: 0.14
Nodes (19): PricingStrategySelector(), strategies, PricingSummaryCard(), PricingBillingConfiguration, ConfigurationValidationIssue, buildPricingAdminPageData(), fleetFromRelease(), issuesForPricingReleasePreview() (+11 more)
...
Cohesion: 0.18
Nodes (14): changedFields(), BusinessConfigurationDomains, actorName(), audit(), mapFleetDraft(), mapPricingDraft(), pricingData(), PrismaPricingAdminRepository (+6 more)
...
Cohesion: 0.19
Nodes (10): rule, saveDocumentPolicyDraftAction(), schema, DocumentPolicyEditor(), configuration(), KEYS, PrismaDocumentConfigurationRepository, validate() (+2 more)
...
Cohesion: 0.12
Nodes (17): devDependencies, postcss, prisma, tsx, tw-animate-css, @types/node, @types/react, @types/react-dom (+9 more)
...
Cohesion: 0.21
Nodes (22): assertSafeInteger(), checkedAdd(), checkedMultiply(), fromBigInt(), majorToMinorUnits(), minorToMajorUnits(), multiplyByBasisPoints(), roundHalfUp() (+14 more)
...
Cohesion: 0.09
Nodes (32): base, createNotificationConfigurationDraftAction(), failure(), manualMethod, refresh(), updateConfirmationContentDraftAction(), updatePaymentInstructionDraftAction(), ConfigurationSectionPage() (+24 more)
...
Cohesion: 0.21
Nodes (11): MoneyInput(), UnsavedChangesWarning(), BulkAction, Table(), TableBody(), TableCaption(), TableCell(), TableFooter() (+3 more)
...
Cohesion: 0.15
Nodes (17): calculateChargeableDuration(), calculateDateOnlyDuration(), calendarDays(), DurationInput, isValidTimeZone(), localDayOrdinal(), pickupBoundaries(), requireValidDate() (+9 more)
...
Cohesion: 0.30
Nodes (10): actionError(), activateConfigurationReleaseAction(), activationSchema, previewConfigurationReleaseAction(), releaseSchema, validateConfigurationReleaseAction(), ActivationConfirmation(), ReleaseWorkflowActions() (+2 more)
...
### Community 246 - "prisma"
Cohesion: 0.22
Nodes (9): NavigationMenu(), NavigationMenuContent(), NavigationMenuIndicator(), NavigationMenuItem(), NavigationMenuLink(), NavigationMenuList(), NavigationMenuTrigger(), navigationMenuTriggerStyle (+1 more)

### Community 248 - "demo-banner.tsx"
Cohesion: 0.60
Nodes (4): Alert(), AlertDescription(), AlertTitle(), alertVariants

### Community 249 - "verify-phase8f-review-concurrency.ts"
Cohesion: 0.40
Nodes (5): decide(), firstClient, main(), parsed, secondClient
...
- **Why does `cn()` connect `Community 5` to `Community 1`, `Community 3`, `server.ts`, `form.tsx`, `reauth-action.ts`, `Community 10`, `Community 11`, `Community 13`, `Community 15`, `Community 17`, `demo-banner.tsx`, `prisma`, `demo-banner.tsx`, `Community 24`, `vehicle-rate-table.tsx`, `carousel.tsx`, `bookings.ts`, `checkout-client.tsx`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Community 47` to `@radix-ui/react-tabs`, `@radix-ui/react-toast`, `server-only`, `Community 22`, `tailwindcss-animate`, `@vercel/analytics`, `@vercel/blob`, `form.tsx`, `Community 49`, `Community 50`, `Community 55`, `Community 56`, `Community 57`, `Community 59`, `Community 61`, `package.json`, `Community 63`, `Community 64`, `Community 65`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 73`, `input-otp`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 86`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 94`, `Community 95`, `Community 96`, `Community 97`, `Community 98`, `Community 99`, `Community 101`, `Community 103`, `Community 104`, `Community 105`, `service.ts`, `@auth/prisma-adapter`?**
