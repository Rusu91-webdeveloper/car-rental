...
describe("chargeable duration", () => {
  ...
  it("allows a morning return before 48 elapsed hours while charging the two-day minimum", () => {
    const result = duration("2026-07-31T11:30:00Z", "2026-08-02T06:00:00Z", {
    ...
    expect(result.elapsedMinutes).toBe(2_550)
