...
function MobileMenuContent({
  ...
  const linkClasses = (active: boolean, tone: "default" | "admin" = "default") =>
    cn(
      ...
      active
        ...
        : "text-foreground/90 hover:bg-muted/75 hover:text-foreground",
      tone === "admin" && "font-semibold text-primary"
    )

  const iconWrapClasses = (active: boolean) =>
    cn(
  ...
  const iconClasses = (active: boolean) =>
    cn("h-5 w-5 shrink-0", active ? "text-primary" : "text-muted-foreground group-hover:text-foreground")
  ...
  return (
    <>
      ...
      {isOpen && (
        <>
          <div
            className="fixed inset-0 z-40 bg-black/45 backdrop-blur-sm animate-in fade-in duration-200"
          ...
          >
            <div className="flex h-full flex-col">
              <div className="flex-shrink-0 border-b border-border/70 px-4 py-3.5">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5 text-primary">
                    <span className="grid h-8 w-8 place-items-center rounded-xl bg-primary text-white shadow-sm shadow-primary/30">
              ...
              >
                <div className="space-y-1">
                  ...
                  >
                    <span className={iconWrapClasses(pathname === "/")}>
                  ...
                  >
                    <span className={iconWrapClasses(pathname === "/cars")}>
                  ...
                  {user && (
                    <>
                      ...
                      >
                        <span className={iconWrapClasses(pathname === "/bookings")}>
                          <svg className={iconClasses(pathname === "/bookings")} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path
                              strokeLinecap="round"
                              strokeLinejoin="round"
                              strokeWidth={2}
                      ...
                      >
                        <span className={iconWrapClasses(pathname === "/saved")}>
                          <svg className={iconClasses(pathname === "/saved")} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path
                              strokeLinecap="round"
                              strokeLinejoin="round"
                              strokeWidth={2}
                      ...
                      >
                        <span className={iconWrapClasses(pathname === "/profile")}>
                          <svg className={iconClasses(pathname === "/profile")} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path
                              strokeLinecap="round"
                              strokeLinejoin="round"
                              strokeWidth={2}
                ...
                <div className="space-y-1">
                  ...
                  >
                    <span className={iconWrapClasses(pathname === "/about")}>
                  ...
                  >
                    <span className={iconWrapClasses(pathname === "/contact")}>
                  ...
                  >
                    <span className={iconWrapClasses(pathname === "/help")}>
                  ...
                  <>
                    ...
                    <div className="space-y-1">
                      <Link
                        href="/admin"
                        onClick={() => setIsOpen(false)}
                        className={linkClasses(pathname === "/admin", "admin")}
                        aria-current={pathname === "/admin" ? "page" : undefined}
                      >
                        <span className={iconWrapClasses(pathname === "/admin")}>
                          <svg className={iconClasses(pathname === "/admin")} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path
                              strokeLinecap="round"
                              strokeLinejoin="round"
                              strokeWidth={2}
              ...
              <div className="flex-shrink-0 border-t border-border/70 px-3 py-3">
                {user ? (
                  <div className="space-y-2">
                    <div className="flex items-center gap-2.5 rounded-xl border border-border/70 bg-background/80 p-2.5">
                  ...
                  <Link
                    href={signInUrl}
                    onClick={() => setIsOpen(false)}
                    className="block w-full rounded-xl bg-primary px-3 py-2.5 text-center text-sm font-semibold text-white shadow-sm shadow-primary/20 transition-colors hover:bg-primary/90"
                  >
                    {t("auth.signIn")}
                  </Link>
                )}
