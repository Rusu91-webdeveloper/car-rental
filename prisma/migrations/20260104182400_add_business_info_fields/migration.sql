-- AlterTable
ALTER TABLE "CompanySettings" ADD COLUMN IF NOT EXISTS "managingDirector" TEXT;
ALTER TABLE "CompanySettings" ADD COLUMN IF NOT EXISTS "commercialRegister" TEXT;
ALTER TABLE "CompanySettings" ADD COLUMN IF NOT EXISTS "registerCourt" TEXT;
ALTER TABLE "CompanySettings" ADD COLUMN IF NOT EXISTS "vatId" TEXT;
ALTER TABLE "CompanySettings" ADD COLUMN IF NOT EXISTS "responsiblePerson" TEXT;
